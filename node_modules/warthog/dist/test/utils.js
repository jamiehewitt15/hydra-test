...
exports.isError = exports.callAPIError = exports.callAPISuccess = exports.callAPI = void 0;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_1 = _a.sent();
                    return [2 /*return*/, __1.getBindingError(error_1)];
...
function callAPISuccess(promise) {
    return __awaiter(this, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, callAPI(promise)];
                case 1:
                    response = _a.sent();
                    if (isError(response)) {
...
exports.callAPISuccess = callAPISuccess;
// Calls our API, throwing an error if encountered
// Use this if a failed API call should fail our test
// This allows us to write more succinct code in our tests because we don't need to
// Type guard around potentially failed error reponses
function callAPIError(promise) {
    return __awaiter(this, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
function toErrorString(obj, msg) {
    var error;
