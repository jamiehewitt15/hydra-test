...
describe('Dotenv files', function () {
    test('Pulls config in correct order', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            process.env = {
                NODE_ENV: 'development',
                WARTHOG_PROPER_ENV_VARIABLE: '12345'
            };
            new config_1.Config({ dotenvPath: __dirname });
