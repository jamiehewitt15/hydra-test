...
exports.createDBConnection = exports.getBaseConfig = void 0;
var typeorm_1 = require("typeorm");
var SnakeNamingStrategy_1 = require("./SnakeNamingStrategy");
...
function getBaseConfig() {
    return {
        ...
        logging: process.env.WARTHOG_DB_LOGGING,
        migrations: getDatabaseMigrationPaths(),
        namingStrategy: new SnakeNamingStrategy_1.SnakeNamingStrategy(),
        ...
        type: process.env.WARTHOG_DB_CONNECTION,
...
exports.createDBConnection = function (dbOptions) {
    if (dbOptions === void 0) { dbOptions = {}; }
    return __awaiter(void 0, void 0, void 0, function () {
        var config;
        return __generator(this, function (_a) {
            config = __assign(__assign({}, getBaseConfig()), dbOptions);
            if (!config.database) {
                throw new Error("createConnection: 'database' is required");
            }
            logger_1.logger.debug('createDBConnection', config);
            return [2 /*return*/, typeorm_1.createConnection(config)]; // TODO: fix any.  It is complaining about `type`
        });
    });
};
function getDatabaseEntityPaths() {
    return process.env.WARTHOG_DB_ENTITIES
        ? process.env.WARTHOG_DB_ENTITIES.split(',')
        : ['src/**/*.model.ts'];
}
function getDatabaseMigrationPaths() {
    return process.env.WARTHOG_DB_MIGRATIONS
        ? process.env.WARTHOG_DB_MIGRATIONS.split(',')
        : ['db/migration/**/*.ts'];
}
function getDatabaseSubscriberPaths() {
